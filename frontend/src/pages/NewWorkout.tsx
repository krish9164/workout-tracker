...
export default function NewWorkout() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    // basic clean-up: only keep rows that are fully filled in
    const clean = rows
      .map((r, idx) => ({
    ...
    try {
      ...
      setOk("Saved! Going to Dashboard…");
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900">
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        ...
        {/* Form */}
        <form onSubmit={submit} className="rounded-xl p-6 bg-white shadow-md space-y-5">
          {/* Basics */}
